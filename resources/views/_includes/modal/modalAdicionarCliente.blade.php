 <div class="modal fade" id="modalVender-{{ $produto->id }}" tabindex="-1" aria-labelledby="modalVender" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <p class="mt-2 text-secondary fs-6">Não encontrei meu cliente. <a href="{{}}"
                                style="color: #8131f8; font-weight: 600;text-decoration: none;"
                                data-bs-target="#modalAddCliente" data-bs-toggle="modal">Cadastrar</a></p>
